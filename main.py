...
def home_page():
    st.title("HarmGuard")
    st.image("saves/images.jfif", width=200)

    st.markdown("""
    ## A Harmful Content Detection

    This project utilizes AI to detect harmful content in videos by analyzing both the visual elements and spoken words.
...
def upload_process_page():
    ...
    uploaded_file = st.file_uploader("", type=["mp4", "avi", "mov", "webm", "mpg"])
